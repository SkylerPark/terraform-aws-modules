...
resource "aws_lb" "this" {
  ...
  security_groups    = var.create_security_group ? concat([module.security_group[0].security_group_id], var.security_groups) : var.security_groups
  subnets            = var.subnets
...
module "security_group" {
  ...
  name                                  = var.security_group_name != "" ? var.security_group_name : "${var.name}-sg"
  description                           = var.security_group_description != "" ? var.security_group_description : "${var.name} SG"
  vpc_id                                = var.vpc_id
